import { Box, Button, Checkbox, Flex, Heading, Icon, Text, Table, Thead, Tbody, Td, Th, Tr, useBreakpointValue, Spinner } from "@chakra-ui/react";
                      ...
                      <Tr key={user.id}>
                        ...
                        <Td>
                          { 
                            ...
                            : 
                            <Button as="a" size="sm" fontSize="small" colorScheme="purple" ml="8"> 
